...
#define dg_configBATTERY_TYPE_CUSTOM_ADC_VOLTAGE        (3439)//4.199v
...
#define dg_configBATTERY_CHARGE_CURRENT         5 // 90ma         4       // 60mA
...
//#define DEBUG_USB_CHARGER                        (1)//SKU WU  USB_CHARGER  充电
//#define DEBUG_USB_CHARGER_PRINT                  (1)

//#define DEBUG_USB_CHARGER_FSM                    (1)

//#define HW_UART2        ((uint16_t *)UART2_BASE) //IN HW_UART.H
//////////////////////////////////////////////////////////////////////



#define dg_configUSE_USB                        1
//USB_CHARGER  充电 debug
...
#define OS_FREERTOS                              /* Define this to use FreeRTOS */
                ...
                //#define configTOTAL_HEAP_SIZE                    13500   /* This is the FreeRTOS Total Heap Size */
                 #define configTOTAL_HEAP_SIZE            (13500+10*1024)   /* This is the FreeRTOS Total Heap Size */  //sku
        #else
               // #define configTOTAL_HEAP_SIZE                    11200   /* This is the FreeRTOS Total Heap Size */
                #define configTOTAL_HEAP_SIZE            (11200+10*1024)   /* This is the FreeRTOS Total Heap Size */  //sku
        #endif
#else
 ...
 */
        ...
        #define CODE_SIZE     (200 * 1024 * 2) //sku
                       ...
                       //#define RAM_SIZE        ( 64 * 1024)
                        #define RAM_SIZE        ( (64-18) * 1024) //sku  datacode

                        #if (proj_configOPTIMAL_RETRAM == 0)
                                //#define RETRAM_0_SIZE   ( 64 * 1024)
                                //#define RETRAM_1_SIZE   (  0 * 1024)
                                #define RETRAM_0_SIZE   ( (64+18) * 1024) //heap stack
                                #define RETRAM_1_SIZE   (  0 * 1024)
                        #else
                               // #define RETRAM_0_SIZE   ( 32 * 1024)
                               // #define RETRAM_1_SIZE   ( 32 * 1024)
                                #define RETRAM_0_SIZE   ( (32) * 1024)//sku
                                #define RETRAM_1_SIZE   ( 32 * 1024)//sku
                        #endif
        #else // MIRRORED
