...
/////////////////////////////////////////////
#if CFG_DEMO_HW_TIMER0  // pwm   motor
        /* Timer0 timer */
...
//userconfig.h中定义 CFG_AD_I2C_1和 CFG_DEMO_HW_I2C
...
#if  CFG_AD_I2C_2  //注意  I2C2_SCL  I2C2_SDA 有一个2
        /* I2C 2 */
        HW_GPIO_PINCONFIG(CFG_GPIO_I2C2_SCL_PORT,
                                                 CFG_GPIO_I2C2_SCL_PIN,    OUTPUT,       I2C2_SCL,   true),
        HW_GPIO_PINCONFIG(CFG_GPIO_I2C2_SDA_PORT,
                                                 CFG_GPIO_I2C2_SDA_PIN,    INPUT,        I2C2_SDA,   true),
#endif //CFG_DEMO_SENSOR_MC3630
...
#       endif
        ...
        hw_gpio_configure_pin(HW_GPIO_PORT_4 , HW_GPIO_PIN_1, HW_GPIO_MODE_INPUT_PULLUP,HW_GPIO_FUNC_GPIO,true);
        //interruper
        //hw_gpio_get_pin_function(HW_GPIO_PORT_4 , HW_GPIO_PIN_4, HW_GPIO_MODE_INPUT_PULLDOWN,HW_GPIO_FUNC_GPIO);
        /*
