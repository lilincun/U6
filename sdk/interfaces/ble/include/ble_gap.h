 ...
 * ble_gap_adv_start() is called. The maximum Advertising Data length is 28 bytes (31 minus 3 that
 * are reserved to set the Advertising Data type flags - which shall not be set in Advertising Data
 * using this function).
 *
...
/**
 * \brief Set the advertising interval prior to advertising start
 *
 ...
 * to be called prior to an advertising start (\sa ble_gap_adv_start()) and will not modify the
 * advertising interval of an ongoing advertising operation.
 *
 ...
 * set the desired scan parameters, and call ble_gap_connect() again.
 *
