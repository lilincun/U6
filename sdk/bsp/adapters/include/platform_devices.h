...
#ifdef CFG_DEMO_SENSOR_PPS960
        /* PXI PAH8002 heart-sensor */
        I2C_SLAVE_DEVICE_DMA(I2C1, PPS960, 0x58, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_FAST,2);
#endif
...
#ifdef  CFG_DEMO_SENSOR_MC3630
I2C_SLAVE_DEVICE_DMA(I2C2, MC3630, 0x4c, HW_I2C_ADDRESSING_7B, HW_I2C_SPEED_STANDARD, 4);
#endif
