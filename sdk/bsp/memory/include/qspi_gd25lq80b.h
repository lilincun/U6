 ...
 *
 * @note This driver/part does NOT support the FLASH_POWER_OFF mode
 *
...
QSPI_SECTION static void flash_gd25lq80b_initialize(uint8_t device_type, uint8_t device_density)
{
...
QSPI_SECTION static void flash_gd25lq80b_sys_clock_cfg(sys_clk_t sys_clk)
{
}

QSPI_SECTION static uint8_t flash_gd25lq80b_get_dymmy_bytes(void)
{
        return 2;
}
#endif
