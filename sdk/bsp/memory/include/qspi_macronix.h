...
QSPI_SECTION __attribute__((unused)) static inline uint8_t flash_mx_read_security_register(void)
{
...
QSPI_SECTION static inline void flash_mx_enable_quad_mode(void)
{
        uint8_t status;
...
QSPI_SECTION static inline void flash_mx_set_output_driver_strength(uint8_t ods_value)
{
...
QSPI_SECTION static inline void flash_mx_configure_dummy_cycles(uint8_t dummy_cycles)
{
        uint8_t new_value;
        uint8_t dc_value;
...
QSPI_SECTION static inline void flash_mx_set_high_performance()
{
        uint8_t cmd[] = { MX_READ_CONFIG_REGISTER };
        uint8_t conf_reg[2];
        uint8_t new_value;
...
QSPI_SECTION static bool flash_mx_is_suspended(void)
{
        __DBG_QSPI_VOLATILE__ uint8_t status;
...
QSPI_SECTION static void flash_mx_deactivate_command_entry_mode(void)
{
